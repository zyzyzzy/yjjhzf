...
class AlipayWapSmController extends PayController
{

    protected $PayName = "AlipayWapSm";  //通道编码
    ...
    public function pay($parameter)
    {
        ...
        $url = parent::qrcodeUrl($parameter["sysordernumber"],$result,$this->PayName);
        parent::Qrcode($url,$parameter["sysordernumber"],$parameter["userordernumber"],$this->PayName,$total_amount);
    }
