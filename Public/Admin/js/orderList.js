 ...
 tableIns =  table.render({
     ...
     ,where:{
      ...
      ,cols: [[
         ...
         ,{field:'complaint', title:'<span id="tips_complaint" style="cursor: pointer">投诉状态 <i class="layui-icon layui-icon-about"></i></span>',templet:'#complaintstatus',width:120}
         ...
         ,{field:'datetime', title:'订单时间',width:160}
         ,{field:'successtime', title:'成功时间',templet:'#successtime',width:160}
         ,{field:'orderid', title:'操作',templet:'#caozuo', fixed: 'right',width:120}
      ]]
      ,page: true
      ,text: {
        none: '无数据'
